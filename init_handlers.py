...
def init_handlers(dispatcher):
    ...
    dispatcher.add_handler(CallbackQueryHandler(earn.visit_url, False, False, 'earn.action.visit_url'))
    dispatcher.add_handler(CallbackQueryHandler(earn.paid_for_visit, False, False, 'earn.visit.paid.*'))
